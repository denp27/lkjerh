...
ADMIN_ID = 123456789                # ⚠️ ЗАМЕНИТЕ на ваш Telegram ID (число) (доступен только он)
...
async def callback_handler(event):
    ...
    try:
        if data == b"main_menu":
            ...
            await event.edit("📂 **Управление Базой Пользователей**\n\nБаза пуста.", buttons=get_db_keyboard())
